...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<%-- 로그인 --%>
	<div class="main w3-padding-32 w3-right" id="login" style="margin: 0 30px 0 0;">
		...
		<c:if test="${empty sessionScope.login }">
			<form action="login.do" name="f_login" method="post">
				<table>
					...
					<tr><td><input type="password" name="pass" placeholder="비밀번호"></td><td colspan="2"><input type="submit" value="로그인"></td></tr>
	...
	<header id="menu">
		<div class="w3-container w3-center">
			<div class="w3-section w3-bottombar w3-padding-16 w3-center" style="width: 1000px; margin:auto;">
				<a href="noticelist.do?bclass=0"><button class="w3-button w3-light-grey">NOTICE</button></a>
				<a href="pointlist.do?bclass=1"><button class="w3-button w3-light-grey">POINT</button></a>
				<a href="reviewlist.do?bclass=2"><button class="w3-button w3-light-grey">REVIEW</button></a>
				<a href="informationlist.do?bclass=3"><button class="w3-button w3-light-grey">INFORMATION</button></a>
				<a href="freelist.do?bclass=4"><button class="w3-button w3-light-grey">FREE</button></a>
			</div>
		</div>
	</header>
	<br>
	...
	<div class="w3-container w3-center margin_auto" style="margin-top: 44px; height: 300px;"> 
      <div class="slide_container bxslider">
		<c:forEach var="il" items="${infolist }">
			<span><a href="information.do?num=${il.num }"><img src="img/${il.file }" width="130" height="180" class="Home_img"></a></span>
		</c:forEach>
		</div>
	</div>
	<br>
